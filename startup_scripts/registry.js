...
StartupEvents.registry('block', event => {
         ...
         event.create('bornite').hardness(3).resistance(3).stoneSoundType().requiresTool(true).tagBlock('minecraft:mineable/pickaxe').tagBlock('minecraft:needs_wool_tool')
         ...
         event.create('hematite').hardness(3).resistance(3).stoneSoundType().requiresTool(true).tagBlock('minecraft:mineable/pickaxe').tagBlock('minecraft:needs_wool_tool')
         event.create('bauxite').hardness(3).resistance(3).stoneSoundType().requiresTool(true).tagBlock('minecraft:mineable/pickaxe').tagBlock('minecraft:needs_iron_tool')
         ...
         event.create('sphalerite').hardness(3).resistance(3).stoneSoundType().requiresTool(true).tagBlock('minecraft:mineable/pickaxe').tagBlock('minecraft:needs_iron_tool')
         event.create('pyrite').hardness(3).resistance(3).stoneSoundType().requiresTool(true).tagBlock('minecraft:mineable/pickaxe').tagBlock('minecraft:needs_wool_tool')
         event.create('chalcopyrite').hardness(3).resistance(3).stoneSoundType().requiresTool(true).tagBlock('minecraft:mineable/pickaxe').tagBlock('minecraft:needs_wool_tool')
